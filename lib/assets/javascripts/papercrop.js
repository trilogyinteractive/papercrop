(function ($) {
  window.posterCrop = {};
  window.posterCrop.jCropApi = null;

  window.posterCrop.init = function() {
    $("div[id$=_cropbox]").each(function() {
      ...
      var update_crop = function(coords) {
        ...
        $("#context-image").css({
          top: $(".jcrop-holder>div").css("top"),
          left: $(".jcrop-holder>div").css("left")
        });
      };
      ...
      $(this).find("img").Jcrop($.extend(opts, callbacks), function() {
        window.posterCrop.jCropApi = this;
      });
    });
  };
